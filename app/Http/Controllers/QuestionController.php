 ...
 public function fetch_data(Request $request){
    ...
    public function store(Request $request)
    {
       ...
       $timestamp = now();
        ...
        $contacts = DB::insert('insert into covid_questions(question_si,question_en,question_ta,marks,created_at) value(?,?,?,?,?)',[$question_si,$question_en,$question_ta,$marks,$timestamp]);
    ...
    public function update(Request $request, $id)
    {
       ...
       $timestamp = now();
			    ...
			    $covid_questions = DB::update('update covid_questions set question_si= ? ,question_en = ? , question_ta = ?,marks=? , updated_at = ? where id = ? ',
        [$question_si,$question_en,$question_ta,$marks,$timestamp,$id]);
