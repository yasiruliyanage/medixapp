...
class CovidMeterController extends Controller
{
   ...
   $record_count = count($covid_questions);
        ...
        return view('divisionagent.covid19meter.dashboard',compact('covid_questions','record_count','divname'));
    }
    ...
    public function createnewinterview()
    {
      ...
      return view('divisionagent.covid19meter.create_interview',compact('patientid','divname'));
    }
  ...
  public function store(Request $request)
    {
       ...
       $patient_department = $usersid;
        ...
        if($insertcovidexaminedpatient){
             ...
             $red = view('divisionagent.covid19meter.questionarie',compact('covid_questions','patient_no','name'));

           // $red = redirect('admin/covid19application/add')->with('success','Question succefully added');

        }else {

            $red = redirect('hospitaladmin/covid19meter/createnew')->with('danger','Input data failed ');
      ...
      public function completequestionarie(Request $request)
    {
       ...
       $this-> validate($request,[
        ...
        return view('divisionagent.covid19meter.covid19meterresult',compact('decession','state','predict_percentage'));
 ...
 public function fetch_data(Request $request){
...

      {
       ...
       if(!empty($query)){
        ...
        return view('divisionagent.pages.covid19application.question_pagination_data',compact('covid_questions','record_count'))->render();
      }
    }
     ...
     public function fetch_trash_data(Request $request){
...

      {
       ...
       if(!empty($query)){
        ...
        return view('divisionagent.pages.covid19application.question_pagination_trash_data',compact('covid_questions','record_count'))->render();
      }
    }
     ...
     public function fetch_decession_data(Request $request){
...

      {
        ...
        return view('divisionagent.pages.covid19application.decession_pagination_data',compact('covid_decessions','record_count'))->render();
      }
    }
    ...
    public function show($id)
    {
        ...
        // $designations = DB::select("select * from designations");
        // $workplaces = DB::select("select * from workplaces");
        return view('divisionagent.pages.covid19application.view_question',compact('covid_questions'));
    }
    ...
    public function edit($id)
    {
      ...
      //  $workplaces = DB::select("select * from workplaces");
        ...
        return view('divisionagent.pages.covid19application.edit_questions',compact('covid_questions'));
    }
 ...
 $userdivid = Auth::user()->division;
      $covid_assessd_patients = DB::table("covid_assessd_patients")->where('inRecycle',0)->where('patient_hospital',$userdivid)->paginate(100);
        ...
        return view('divisionagent.covid19meter.manage_patients',compact('covid_assessd_patients','provinces','districts','zones','divisions','schools','subjects','record_count','divname'));
     ...
     public function fetch_patient_data(Request $request){
...

      {
       ...
       if(!empty($query)){
		 ...
		 ->where('patient_hospital','=',$hospital) 
     ...
     // dd($interviewddate);
       ...
       // $record_count = count($covid_assessd_patients);
        ...
        return view('divisionagent.covid19meter.patient_pagination_data',compact('covid_assessd_patients','record_count'))->render();
      }
    }
    ...
    public function patientinfo($id)
    {
        ...
        return view('divisionagent.covid19meter.patient_profile',compact('covidpatient','provinces','districts','zones','divisions','schools','divname'));
  ...
  $userdivid = Auth::user()->division;
      ...
      //  $workplaces = DB::select("select * from workplaces");
        ...
        return view('divisionagent.covid19meter.edit_patient',compact('covidpatient','divname'));
    }
    ...
    public function patientupdate(Request $request, $id)
    {
      ...
      $userdivid = Auth::user()->division;
       ...
       if($covidpatientupdate) {
            $red = redirect('hospitaladmin/covid19meter/patients')->with('success','Patient Data has been updated');
          

       }else {

         $red = redirect('hospitaladmin/covid19meter/edit/',$id)->with('danger','Error update please try again');
