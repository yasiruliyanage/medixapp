...
class SchoolAgentAdminController extends Controller
{
    ...
    public function create(Request $request)
    {
      $userdivid = Auth::user()->division;
        ...
        return view('divisionagent.pages.schooladmin.add_school_agent_admin',compact('schools','divname','newregid'));
    }
    ...
    public function show($id)
    {
      ...
      $userdivid=Auth::user()->division;
        ...
        // $workplaces = DB::select("select * from workplaces");
		 $getdivname = DB::select('select * from divisions where id=?',[$userdivid]);
        $divname=$getdivname[0]->placename;
        return view('divisionagent.pages.schooladmin.school_agent_profile_admin',compact('agents','schools','divname'));
    }
      ...
      $oldreacordinfo = DB::select('select * from  admins where id=?',[$id]);
       ...
       if($agents) {
        ...
        DB::update('update schools set s_a_count=? where id=?',[$countinschoolt,$s_id]);
            ...
            $red = redirect('hospitaladmin/departmentadmins')->with('success','Department agent Data has been updated');
