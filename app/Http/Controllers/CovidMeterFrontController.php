...
class CovidMeterFrontController extends Controller
{
...

    {
       ...
       // $workplaces = DB::select("select * from workplaces");
        ...
        return view('frontend.covid19meter.dashboard',compact('covid_questions','record_count'));
    }
    ...
    public function createnewinterview()
    {
      ...
      $hospitals = DB::select("select * from divisions");
      //  $workplaces = DB::select("select * from workplaces");
      ...
      return view('frontend.pages.selftest',compact('patientid','hospitals'));
    }
  ...
  public function store(Request $request)
    {
       ...
       $patient_hospital = $userdivid;
        ...
        $insertcovidexaminedpatient = DB::insert('insert into covid_assessd_patients(patient_no,name,nic,phone,profile_img,patient_hospital,interview_status,reg_type,interviewed_at,created_at) value(?,?,?,?,?,?,?,?,?,?)',[$patient_no,$name,$nic,$phone,$new_name,$patient_hospital,$interview_status,$reg_type,$timestamp,$timestamp]);
  ...
  $covid_decession_factors = DB::select('select * from covid_decession_factors');
	  ...
	  //dd($allquestionmarkstotal);
        ...
        if($insertcovidexaminedpatient){
             ...
             $red = view('frontend.pages.questionary',compact('covid_questions','patient_no','name','allquestionmarkstotal','percentage1','percentage2','percentage3','percentage4','patientnewid'));

           // $red = redirect('admin/covid19application/add')->with('success','Question succefully added');

        }else {

            $red = redirect('selftest/newtest')->with('danger','Input data failed ');
      ...
      //  $predict_percentage = ($answeredquestionscount/$questionscount)*100;
        ...
        $update_patient_status = DB::update('update covid_assessd_patients set patient_results =? , patient_result_decission =?,interview_status=?,patientreport=? where id = ?',[ $predict_percentage,$state,$interview_status,$fileName,$pid]);
         ...
         $pdf->save($path . '/' . $fileName);
          ...
          $red = redirect('selftest/')->with('success','Patient and Questionarie saved Successfully ');
 ...
 public function fetch_data(Request $request){
...

      {
       ...
       if(!empty($query)){
        ...
        return view('frontend.pages.covid19application.question_pagination_data',compact('covid_questions','record_count'))->render();
      }
    }
     ...
     public function fetch_trash_data(Request $request){
...

      {
       ...
       if(!empty($query)){
        ...
        return view('frontend.pages.covid19application.question_pagination_trash_data',compact('covid_questions','record_count'))->render();
      }
    }
     ...
     public function fetch_decession_data(Request $request){
...

      {
        ...
        return view('frontend.pages.covid19application.decession_pagination_data',compact('covid_decessions','record_count'))->render();
      }
    }
    ...
    public function show($id)
    {
        ...
        // $designations = DB::select("select * from designations");
        // $workplaces = DB::select("select * from workplaces");
        return view('frontend.pages.covid19application.view_question',compact('covid_questions'));
    }
    ...
    public function edit($id)
    {
      ...
      //  $workplaces = DB::select("select * from workplaces");
        ...
        return view('frontend.pages.covid19application.edit_questions',compact('covid_questions'));
    }
    ...
    public function decessionedit($id)
    {
      ...
      //  $workplaces = DB::select("select * from workplaces");
        ...
        return view('frontend.pages.covid19application.edit_decession',compact('covid_decession'));
    }
      ...
      public function showTrash()
    {
        $covid_questions = DB::table("covid_questions")->where('inRecycle',1)->paginate(100);
          $record_count = count($covid_questions);
        return view('frontend.pages.covid19application.manage_questions_trash',compact('covid_questions','record_count'));
    }
     ...
     public function getcovidpatients(Request $request){
        ...
        return view('frontend.covid19meter.manage_patients',compact('covid_assessd_patients','provinces','districts','zones','divisions','schools','subjects','record_count'));
     ...
     public function fetch_patient_data(Request $request){
      ...
      //dd($interviewddate);
        ...
        return view('frontend.covid19meter.patient_pagination_data',compact('covid_assessd_patients','record_count'))->render();
      }
    }
    ...
    public function patientinfo($id)
    {
        ...
        return view('frontend.covid19meter.patient_profile',compact('covidpatient','provinces','districts','zones','divisions','schools'));
    ...
    public function editpatientinfo($id)
    {
      ...
      //  $workplaces = DB::select("select * from workplaces");
        ...
        return view('frontend.covid19meter.edit_patient',compact('covidpatient'));
    }
