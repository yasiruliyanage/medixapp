  ...
  <div class="col-md-12">
      ...
      <div class="card">
        <h4 align="center">Workplace Manage</h4>
            <form method="post" action="{{route('workplace.edit',$workplace->id)}}" class="form-horizontal">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="form-group label-floating is-empty">
                        ...
                        <input type="text" name="place_name" class="form-control" value="{{$workplace->placename}}">
