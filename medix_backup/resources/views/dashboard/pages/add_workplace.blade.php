...
<div class="col-md-12">
  <div class="col-md-12">
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Workplace Manage</h4>
            <form method="post" action="{{route('workplace.add')}}" class="form-horizontal">
        ...
        <div class="card-content">
            ...
            <a href="{{route('workplace.workplaces')}}" class="btn btn-danger pull-right" >Cancel</a>
