                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Province Agents</h4>
                              ...
                              <form action="/deleteallprovinceagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/deleteallprovinceagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Delete?')" >Delete All Selected </button>
                                <button formaction="/restoreallprovinceagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('dashboard.pages.provinceadmin.province_agent_trash_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,province,query)
            {
                $.ajax({
                    ...
                    url:"provinceagents/fetch_trash_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&province="+province+"&query="+query,
