...
<div class="col-md-12">
	@foreach($members as $member)
			<div class="card">
				<h4 align="center">User Details - {{$member->name}} {{$member->lname}} , {{$member->ps_number}}  - Registered At - {{$member->created_at}}</h4>
				  <form method="get" action="manage_member.html" class="form-horizontal">
					<!--div class="card-header card-header-text" data-background-color="rose">
						...
						<div class="row">
							<label class="col-sm-2 label-on-left">Member  ID</label>
