...
<div class="col-md-12">
			<div class="card">
				...
				<h4 align="center" style="font-weight:500;font-size:20px;">All Transfer Cycles  </h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             <td> <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="cids[]"   class="selectbox" value="{{$transfercycle->c_id}}" >
                                                        </label>
                                                    </div> </td>
                                            ...
                                            <td class="td-actions text-left">
                                                 ...
                                                 <a href="{{action('TransferBoardController@getCycleInfo',$transfercycle->c_id)}}" onclick="return confirm('Are you sure you want to transfer?')" type="button" class="btn-success"><i class="material-icons btn-success ">transfer_within_a_station</i></a>
                                                  <a href="{{action('TransferBoardController@ExportTransferCycleToExcel',$transfercycle->c_id)}}"  type="button" class="btn-success"><i class="far fa-file-excel btn-success" style="padding:6px;"></i></a>
                                                   <a href="{{action('TransferBoardController@ExportCyclesToWordDocx',$transfercycle->c_id)}}"  type="button" class="btn-success"><i class="far fa-file-word btn-primary" style="padding:6px;"></i></a>
                                                   <a href="{{action('TransferBoardController@ExportCycleToPDF',$transfercycle->c_id)}}"  type="button" class="btn-success"><i class="far fa-file-pdf btn-danger" style="padding:6px;"></i></a> 
