...
@section('content')
                       ...
                       @if($message = Session::get('success'))
                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title"> Hosptal Admins</h4>
                              <form action="/deletealldivisionalagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/deleteallhospitaladmins" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Delete?')" >Delete All Selected </button>
                                <button formaction="/restoreallhospitaladmins" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     ...
                                     @include('dashboard.pages.divisionadmin.divisional_agent_trash_pagination_data')
  ...
  <script>
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,province,district,zone,division,query)
            {
                $.ajax({

                    url:"hospitaladmins/fetch_trash_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&province="+province+"&district="+district+"&zone="+zone+"&division="+division+"&query="+query,
         ...
         console.log(province_id);
                ...
                fetch_data(page,sort_type,column_name,province_id,district_id,zone_id,division_id,query);
            ...
            $(document).on('click','.sorting',function(){
              ...
              var district_id= $('#did').val();
               ...
               var division_id= $('#divid').val();
                ...
                fetch_data(page,reverse_order,column_name,province_id,district_id,zone_id,division_id,query);
