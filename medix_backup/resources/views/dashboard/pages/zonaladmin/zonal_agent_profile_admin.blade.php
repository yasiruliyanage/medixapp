...
@section('title')
  Profile - Manage Zonal  Agents CTSU
@endsection
@section('content')
...
<div class="col-md-12">
	@foreach($agents as $member)
			<div class="card">
				<h4 align="center">Zonal Agent Details - {{$member->name}} {{$member->lname}} , {{$member->ps_number}}</h4>
...
<a href="/admin/zonalagents" class="btn btn-info pull-right">Back</a>
