        ...
        <div class="sidebar" data-active-color="rose" data-background-color="black" data-image="{{URL::asset('assets/assets/img/sidebar-t.jpg')}}">
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="province_dash">
                            <i class="material-icons">dashboard</i>
                            <p> Province Agent Dashboard </p>
                        </a>
                    </li>
                    ...
                    <!--############################  District Agents   #####################################-->
                    <li>
                        <a data-toggle="collapse" href="#dis_pa">
                        ...
                        <div class="collapse" id="dis_pa">
                            <ul class="nav">

                                <li>
                                    <a href="add_dis_a_pa">
                                        <span class="sidebar-mini">NDA </span>
                                        <span class="sidebar-normal"> Register New District Agent </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="mng_dis_a_pa">
                                        ...
                                        <span class="sidebar-normal"> Manage District Agents</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="dlt_dis_a_pa">
                                        ...
                                        <span class="sidebar-normal"> Deleted District Agents </span>
                                    </a>
                                </li>
                    ...
                    <!--############################  Zonal Agents   #####################################-->
                    <li>
                        <a data-toggle="collapse" href="#za_pa">
                            <i class="material-icons">contacts</i>
                            <p>Zonal Agents
                                <b class="caret"></b>
                            </p>
                        ...
                        <div class="collapse" id="za_pa">
                            <ul class="nav">

                                <li>
                                    <a href="add_z_a_pa">
                                        <span class="sidebar-mini">NZA </span>
                                        <span class="sidebar-normal"> Register New Zonal Agent </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="mng_z_a_pa">
                                        <span class="sidebar-mini"> MZA </span>
                                        <span class="sidebar-normal"> Manage Zonal Agents</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="dlt_z_a_pa">
                                        <span class="sidebar-mini"> DZA </span>
                                        <span class="sidebar-normal"> Deleted Zonal Agents </span>
                                    </a>
                                </li>
                    ...
                    <!--############################  Divisional Agents   #####################################-->
                    <li>
                        <a data-toggle="collapse" href="#div_pa">
                            <i class="material-icons">contacts</i>
                            <p>Division Agents
                                <b class="caret"></b>
                            </p>
                        ...
                        <div class="collapse" id="div_pa">
                            <ul class="nav">

                                <li>
                                    <a href="add_div_a_pa">
                                        <span class="sidebar-mini">NDA </span>
                                        <span class="sidebar-normal"> Register New Division Agent </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="mng_div_a_pa">
                                        <span class="sidebar-mini"> MDA </span>
                                        <span class="sidebar-normal"> Manage Division Agents</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="dlt_div_a_pa">
                                        <span class="sidebar-mini"> DDA </span>
                                        <span class="sidebar-normal"> Deleted Division Agents </span>
                                    </a>
                                </li>
                        ...
                        <div class="collapse" id="sa">
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="add_s_a_pa">
                                        <span class="sidebar-mini">NDA </span>
                                        <span class="sidebar-normal"> Register New School Agent </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="mng_s_a_pa">
                                        <span class="sidebar-mini"> MDA </span>
                                        <span class="sidebar-normal"> Manage School Agents</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="dlt_s_a_pa">
                                        <span class="sidebar-mini"> DDA </span>
                                        <span class="sidebar-normal"> Deleted School Agents </span>
                                    </a>
                                </li>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="formsExamples">
                            <ul class="nav">
                                <li>
                                    <a href="mng_province_pa">
                                        <span class="sidebar-mini"> MP </span>
                                        <span class="sidebar-normal">Manage Province </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mng_district_pa">
                                        <span class="sidebar-mini"> MD </span>
                                        <span class="sidebar-normal">Manage District </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mng_zone_pa">
                                        <span class="sidebar-mini"> MZ </span>
                                        <span class="sidebar-normal">Manage Zone </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mng_division_pa">
                                        <span class="sidebar-mini"> MD </span>
                                        <span class="sidebar-normal">Manage Division </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mng_school_pa">
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Province Agent Dashboard
