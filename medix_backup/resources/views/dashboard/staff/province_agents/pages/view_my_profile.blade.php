...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <h4 align="center">Province Agent Details - FIRSTNAME,LASTNAME,Registration ID</h4>
                <form method="" action="view_mem" class="form-horizontal">
                    <div class="card-content">
                        ...
                        <div class="row">
                            <label class="col-sm-2 label-on-left">Provine</label>
                        ...
                        <a href="province_dash" class="btn btn-danger pull-right">Back</a>
                        <a href="edit_p_a_pro" class="btn btn-warning pull-right">Edit</a>
                    </div>
                </form>
