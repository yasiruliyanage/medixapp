 ...
 <div class="col-md-12">
     <div class="col-md-12">
         <div class="card">
             <h4 align="center" style="font-weight:500;font-size:20px;">Edit Zone </h4>
                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-10">
                             <div class="form-group label-floating is-empty">
                                 ...
                                 <span class="help-block">Please enter Zone.</span>
                             </div>
                         </div>
                     </div>
                     <a href="mng_zone_disa" class="btn btn-danger pull-right">Cancel</a>
