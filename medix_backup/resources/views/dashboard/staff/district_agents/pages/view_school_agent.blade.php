...
@section('title')
Profile - Manage School Agent CTSU
@endsection
@section('content')
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <h4 align="center">School Agent Details - FIRSTNAME,LASTNAME,Registration ID</h4>
                <form method="" action="view_mem" class="form-horizontal">
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <a href="mng_s_a_disa" class="btn btn-danger pull-right">Back</a>
                            <a href="" class="btn btn-info pull-right">Print</a>
                            <a href="edit_s_a_disa" class="btn btn-warning pull-right">Edit</a>
