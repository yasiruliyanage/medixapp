...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <h4 align="center">Member Details - FIRSTNAME,LASTNAME,Registration ID</h4>
                <form method="" action="view_mem" class="form-horizontal">
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <a href="mng_mem_disa" class="btn btn-danger pull-right">Back</a>
                            <a href="" class="btn btn-info pull-right">Print</a>
                            <a href="edit_mem_disa" class="btn btn-warning pull-right">Edit</a>
