...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <h4 align="center">Zonal Agent Details - FIRSTNAME,LASTNAME,Registration ID</h4>
                <form method="" action="view_mem" class="form-horizontal">
                    <div class="card-content">
                        ...
                        <a href="zonal_dash" class="btn btn-danger pull-right">Back</a>
                        <a href="edit_z_a_pro" class="btn btn-warning pull-right">Edit</a>
                    </div>
                </form>
