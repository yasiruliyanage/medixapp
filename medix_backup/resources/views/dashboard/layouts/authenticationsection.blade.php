...
<body class="off-canvas-sidebar">
    ...
    <div id="loginimg" class="wrapper wrapper-full-page">
            <div  class="full-page login-page clear-filter " filter-color="blue" data-image="{{URL::asset('assets/assets/img/login.jpg')}}">
            ...
            <footer  id="loginftr" class="footer">
                <div id="ftext"  class="container">
                    ...
                    <p  class="copyright text-center" style="padding-top: 30px;">
                               Copyright © <?php echo date('Y') ?>.Medix.lk Developed By <a style="color:white !important;" href="https://www.cisworld.lk/" target="_blank"> CIS WORLD</a>
