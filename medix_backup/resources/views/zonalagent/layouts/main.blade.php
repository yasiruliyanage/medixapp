...
<body >
   ...
   <div class="sidebar-wrapper">
    <div class="user">
        <div class="photo">
            <img src="{{URL::to('/')}}/zonalagents/profileimg/{{Auth::user()->profile_img}}" />
        </div>
        <div class="info">
           ...
           <div class="collapse" id="collapseExample">
            <ul class="nav">
                 <li class="@if ($nav == 'my_profile') active @endif">
                    <a href="{{route('zonalagentuser.profile')}}">
                        <span class="sidebar-mini"> MP </span>
                        <span class="sidebar-normal"> My Profile </span>
                    </a>
                </li>
                <li class="@if ($nav == 'edit_profile') active @endif">
                    <a href="{{route('zonalagentuser.editprofile')}}">
                        <span class="sidebar-mini"> EP </span>
                        <span class="sidebar-normal"> Edit Profile </span>
                    </a>
                </li>
                 <li class="@if ($nav == 'change_pass') active @endif">
                    <a href="{{route('zonalagentuser.changepassword')}}">
...
<ul class="nav">
    ...
    <li >
        <a href="{{route('zonalagentuser.home')}}">
            <i class="material-icons">dashoard </i>
            <p>Zonal Agent Dashboard </p>
        </a>
    </li>
    ...
    <li class="@if ($nav == 'member_admin') active @endif">
     ...
     <div class="collapse" id="pagesExamples">
        <ul class="nav">
            <li>
                <a href="{{route('zonalagentuser.members')}}">
                    <span class="sidebar-mini"> TIP </span>
                    <span class="sidebar-normal">Teachers in District</span>
                </a>
            </li>
        </ul>
    </div>
...
<!--############################  Staff Members   #####################################-->
     ...
     <div class="collapse" id="pagesExamplesS">
        <ul class="nav">
			  ...
			  <li>
                <a href="{{route('zonaldivisionagent.add')}}">
                    <span class="sidebar-mini"> RDA </span>
                    <span class="sidebar-normal"> Register New Divisional Agent </span>
                </a>
            </li>
		
            
			<li>
                <a href="{{route('zonaldivisionagent.agents')}}">
                    <span class="sidebar-mini"> MDA </span>
                    <span class="sidebar-normal"> Manage Divisional Agents </span>
                </a>
            </li>
			 
			 <li>
                <a href="{{route('zonaldivisionagent.deletedagents')}}">
                    <span class="sidebar-mini"> DDA </span>
                    <span class="sidebar-normal"> Deleted Divisional Agents</span>
                </a>
            </li>
...
<!--############################  Staff Members   #####################################-->
     ...
     <div class="collapse" id="pagesExamplesSCA">
        <ul class="nav">
              ...
              <li>
                <a href="{{route('zonalagentuser.schools')}}">
 ...
 <nav class="navbar navbar-transparent navbar-absolute">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"> Zonal Agent Dashboard {{$zname}} Zone  @if (session('status'))
