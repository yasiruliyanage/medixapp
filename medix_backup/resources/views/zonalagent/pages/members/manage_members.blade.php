...
@section('title')
  Home-Manage Provnce Members CTSU
@endsection
@section('content')
<?php $nav = 'member_admin'; ?>
                            ...
                            <h4 class="card-title">Teachers</h4>
                              ...
                              <form action="/recycleAll"  method="post">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('zonalagent.pages.members.member_pagination_data')
    ...
    <script>
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,division,school,query)
            {
                $.ajax({

                    url:"members/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&division="+division+"&school="+school+"&query="+query,
       ...
       //  console.log(province_id);
                ...
                fetch_data(page,sort_type,column_name,division_id,school_id,query);
           ...
           //sorting function
            $(document).on('click','.sorting',function(){
               ...
               var division_id= $('#divid').val();
                ...
                fetch_data(page,reverse_order,column_name,division_id,school_id,query);
