                            ...
                            <h4 class="card-title">School Agents</h4>
                              <form action="/recycleAllschoolagents"  method="post">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('zonalagent.pages.schooladmin.school_agent_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,division,school,query)
            {
                $.ajax({
                    ...
                    url:"schoolagents/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&division="+division+"&school="+school+"&query="+query,
