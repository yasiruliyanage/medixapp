                         ...
                         <div class="card-content">
                            <h4 class="card-title">Hospital Type Admins</h4>
                              <form action="/recycleAllhospitaltypeadmins"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/recycleAllhospitaltypeadmins" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,zone,query)
            {
                $.ajax({
                    ...
                    url:"hospitaltypeadmins/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&zone="+zone+"&query="+query,
