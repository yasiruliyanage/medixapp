...
<?php $nav = 'zonal_admin'; ?>
                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Hospital Type Admins</h4>
                              <form action="/deleteallhospitaltypeadmins"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/deleteallhospitaltypeadmins" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <button formaction="/restoreallhospitaltypeadmins" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
                                      <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <option value="" disable="true" selected="true" >Select Hospitaltype</option>
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('districtagent.pages.zonaladmin.zonal_agent_trash_pagination_data')
   ...
   <script>
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,zone,query)
            {
                $.ajax({

                    url:"zonalagents/fetch_trash_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&zone="+zone+"&query="+query,
          ...
          $('.filtercheck').change(function(){
               ...
               var page = $('#hidden_page').val();
                ...
                fetch_data(page,sort_type,column_name,zone_id,query);
           ...
           //sorting function
            $(document).on('click','.sorting',function(){
               ...
               var zone_id= $('#zid').val();
                ...
                fetch_data(page,reverse_order,column_name,zone_id,query);
