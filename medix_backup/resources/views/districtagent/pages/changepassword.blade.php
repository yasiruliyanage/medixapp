  ...
  <div class="col-md-12">
   <div class="card">
    <h4 align="center">Change Password</h4>
        <form method="POST" action="{{route('districtagentuser.changepassword')}}" class="form-horizontal" enctype="multipart/form-data">
          {{csrf_field()}}
               @if(count($errors) > 0 )
...
<a href="{{route('districtagentuser.home')}}" class="btn btn-info pull-right">Back</a>
</div>
</form>
</div>
</div>
