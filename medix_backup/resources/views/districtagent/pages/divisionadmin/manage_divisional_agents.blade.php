...
<?php $nav = 'divisional_admin'; ?>
                            ...
                            <h4 class="card-title">Divisional Agents</h4>
                              <form action="/recycleAlldistricagents"  method="post">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('districtagent.pages.divisionadmin.divisional_agent_pagination_data')
  ...
  <script>
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,zone,division,query)
            {
                $.ajax({

                    url:"divisionagents/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&zone="+zone+"&division="+division+"&query="+query,
          ...
          $('.filtercheck').change(function(){
               ...
               var page = $('#hidden_page').val();
                ...
                fetch_data(page,sort_type,column_name,zone_id,division_id,query);
           ...
           //sorting function
            $(document).on('click','.sorting',function(){
               ...
               var division_id= $('#divid').val();
                ...
                fetch_data(page,reverse_order,column_name,zone_id,division_id,query);
