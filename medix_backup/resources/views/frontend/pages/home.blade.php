            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="banner_img">
                        <img src="{{URL::asset('medix/img/banner_img.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6 col-lg-6">
                    <div class="about_us_img">
                        <img src="{{URL::asset('medix/img/top_service.png')}}" alt="">
                    </div>
                </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-3 col-sm-12">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><img src="{{URL::asset('medix/img/icon/feature_1.svg')}}" alt=""></span>
                            <h4>Better Future</h4>
                    ...
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><img src="{{URL::asset('medix/img/icon/feature_2.svg')}}" alt=""></span>
                            <h4>Better Future</h4>
                            <p>Darkness multiply rule Which from without life creature blessed
                                give moveth moveth seas make day which divided our have.</p>
                        </div>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="single_feature_img">
                        <img src="{{URL::asset('medix/img/service.png')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-3 col-sm-12">
                    <div class="single_feature">
