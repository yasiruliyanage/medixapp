...
<div class="row">
    ...
    <picture>
        <img src="{{URL::to('/')}}/members/profileimg/{{Auth::user()->profile_img}}" alt="" style="width:200px;height: 200px;" disabled>
      </picture>
</div>
...
<a href="{{route('user.editprofile')}}" class="btn btn-warning pull-right" >Edit</a>
