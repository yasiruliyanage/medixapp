...
<?php $nav = 'zonal_admin'; ?>
                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Zonal Agents</h4>
                              <form action="/recycleAllzonalagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/recycleAllzonalagents" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
                                      <div class="col-md-2">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('provinceagent.pages.zonaladmin.zonal_agent_pagination_data')
   ...
   <script>
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,district,zone,query)
            {
                $.ajax({

                    url:"zonalagents/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&district="+district+"&zone="+zone+"&query="+query,
          ...
          $('.filtercheck').change(function(){
              ...
              var district_id= $('#did').val();
               ...
               var page = $('#hidden_page').val();
                ...
                fetch_data(page,sort_type,column_name,district_id,zone_id,query);
            ...
            $(document).on('click','.sorting',function(){
              ...
              var district_id= $('#did').val();
               var zone_id= $('#zid').val();
                ...
                fetch_data(page,reverse_order,column_name,district_id,zone_id,query);
