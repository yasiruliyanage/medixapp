...
class DistrictAgentAdminController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       // $user = Auth::user();
        ...
        $agents = DB::table("admins")->where('inRecycle',0)->where('role_id',4)->paginate(2);
      ...
      //  ['members'=>$members]
        ...
        return view('dashboard.pages.districtadmin.manage_district_agents',compact('agents','provinces','districts','record_count'));
    }
    ...
    public function fetch_data(Request $request){
...

      {
       ...
       }else if(empty($query))
       {
          ...
          $agents = DB::table('admins')->where('inRecycle',0)->where('role_id',4)->orderBy($sort_by,$sort_type)->paginate(2);
         ...
         $agents = DB::table('admins')->where('inRecycle',0)->where('role_id',4)->where('province',$province)->where('district',$district)->orderBy($sort_by,$sort_type)->paginate(2);

         $record_count = count($agents);
        
        }elseif((empty($province))&&(!empty($district))){
          
         $agents = DB::table('admins')->where('inRecycle',0)->where('role_id',4)->where('district',$district)->orderBy($sort_by,$sort_type)->paginate(2);

         $record_count = count($agents);
        
        }elseif((!empty($province))&&(empty($district))){
          
         $agents = DB::table('admins')->where('inRecycle',0)->where('role_id',4)->where('province',$province)->orderBy($sort_by,$sort_type)->paginate(2);
        ...
        return view('dashboard.pages.districtadmin.district_agent_pagination_data',compact('agents','record_count'))->render();
      }
    }
 ...
 public function fetch_trash_data(Request $request){
...

      {
       ...
       }else if(empty($query))
       {
          ...
          $agents = DB::table('admins')->where('inRecycle',1)->where('role_id',4)->orderBy($sort_by,$sort_type)->paginate(2);
         ...
         $agents = DB::table('admins')->where('inRecycle',1)->where('role_id',4)->where('province',$province)->where('district',$district)->orderBy($sort_by,$sort_type)->paginate(2);

         $record_count = count($agents);
        
        }elseif((empty($province))&&(!empty($district))){
          
         $agents = DB::table('admins')->where('inRecycle',1)->where('role_id',4)->where('district',$district)->orderBy($sort_by,$sort_type)->paginate(2);

         $record_count = count($agents);
        
        }elseif((!empty($province))&&(empty($district))){
          
         $agents = DB::table('admins')->where('inRecycle',1)->where('role_id',4)->where('province',$province)->orderBy($sort_by,$sort_type)->paginate(2);
        ...
        return view('dashboard.pages.districtadmin.district_agent_trash_pagination_data',compact('agents','record_count'))->render();
      }
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('dashboard.pages.districtadmin.add_district_agent_admin',compact('provinces','districts','newregid'));
    }
       ...
       $message=$employee_id.'You are now added CTSU Online UMS SYSTEM as District agent  Username:'.$username.'Password:'.$passwordorginal.'Please Log in to http://www.ctsu.lk/admin/login'; 
        ...
        if($agent){
           ...
           //assign role to agent 
            ...
            $red = redirect('admin/districtagents/add')->with('success','District Agent succefully added');

        }else {
            $red = redirect('districtagents/add')->with('danger','Input data failed ');
        }
	   }else {
		    $red = redirect('districtagents/add')->with('danger','nic already exists ');
	   }
    ...
    public function show($id)
    {
        ...
        // $designations = DB::select("select * from designations");
        // $workplaces = DB::select("select * from workplaces");
        return view('dashboard.pages.districtadmin.district_agent_profile_admin',compact('agents','provinces','districts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.pages.districtadmin.edit_district_agent_admin',compact('agents','provinces','districts'));
    }
     ...
     $message=$employee_id.'Your password changed succesfully CTSU Online Database. Username: '.$username.' ,      Password:'.$passwordorginal.'Please Log in to http://www.ctsu.lk/admin/login';
       ...
       if($agents) {
        ...
        DB::update('update  district set d_a_count=? where id=?',[$countindistrictt,$d_id]);
            ...
            $alias='CTSU - District Agent Registration';
            ...
            $sms->closeSession($session); 
            $red = redirect('admin/districtagents')->with('success','District agent  has been updated Successfully');
      ...
      //deleting old file when updating new one
       ...
       if($agents) {
        ...
        DB::update('update  district set d_a_count=? where id=?',[$countindistrictt,$d_id]);
          ...
          $red = redirect('admin/districtagents')->with('success','Data has been updated');
    ...
    public function destroy($id)
    {
      ...
      $oldreacordinfo = DB::select('select * from  admins where id=?',[$id]);
       ...
       //counting new agent count in province
        ...
        $red = redirect('admin/deleteddistrictagents');
        return $red;
    }
    ...
    public function deleteAll(Request $request){
        ...
        return redirect('admin/districtagents/deleteddistrictagents');
        ...
        return redirect('admin/districtagents/');
    ...
    public function recycle($id)
    {
        ...
        $red = redirect('admin/districtagents');
        return $red;
    }
    ...
    {
         $agents = DB::table("admins")->where('inRecycle',1)->where('role_id',4)->paginate(2);
      ...
      //  ['members'=>$members]
         ...
         $record_count = count($agents);
		  //dd($agents);
        return view('dashboard.pages.districtadmin.district_agent_admin_trash',compact('agents','provinces','districts','record_count'));
    }
