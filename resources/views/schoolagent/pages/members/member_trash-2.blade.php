                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Deleted Teachers</h4>
                              ...
                              <form action="members/restoreallschoolagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="members/deleteallschoolagents" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
                                    <button formaction="members/restoreallschoolagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('schoolagent.pages.members.member_trash_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,query)
            {
                $.ajax({
                    ...
                    url:"members/fetch_trash_data?page="+page+"&sortby="+sort_by+"&sorttype="+"&query="+query,
