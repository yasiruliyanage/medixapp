                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Deleted Teachers</h4>
                              ...
                              <form action="restoreallmembers"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="deleteallmembers" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                 <button formaction="restoreallmembers" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,query)
            {
                $.ajax({
                    ...
                    url:"fetch_trash_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
