...
<body >
	<div class="wrapper">
       ...
       <div class="sidebar" data-active-color="purple" data-background-color="white" data-image="{{URL::asset('assets/assets/img/sidebar-1.jpg')}}">
    <!--
   ...
   <div class="sidebar-wrapper">
    <div class="user">
        <div class="photo" style="width:60px;height:60px">
            ...
            <img src="{{URL::to('/')}}/schoolagents/profileimg/male-avatar.png" />
			<?php }else {?>
			<img src="{{URL::to('/')}}/schoolagents/profileimg/female-avatar.png" />
			<?php }?>
           ...
           <div class="collapse" id="collapseExample">
            <ul class="nav">
                 <li class="@if ($nav == 'my_profile') active @endif">
                    <a href="{{route('schoolagentuser.profile')}}">
                        <span class="sidebar-mini"> MP </span>
                        <span class="sidebar-normal"> My Profile </span>
                    </a>
                </li>
                <li class="@if ($nav == 'edit_profile') active @endif">
                    <a href="{{route('schoolagentuser.editprofile')}}">
                        <span class="sidebar-mini"> EP </span>
                        <span class="sidebar-normal"> Edit Profile </span>
                    </a>
                </li>
                 <li class="@if ($nav == 'change_pass') active @endif">
                    <a href="{{route('schoolagentuser.changepassword')}}">
...
<ul class="nav">
    ...
    <li >
        <a href="{{route('schoolagentuser.home')}}">
...
<!--############################  Staff Members   #####################################-->
     ...
     <div class="collapse" id="pagesExamplesS">
        <ul class="nav">
			  ...
			  <li>
                <a href="{{route('schoolagentmember.add')}}">
                    <span class="sidebar-mini"> RNM </span>
                    <span class="sidebar-normal"> Register New Users </span>
                </a>
            </li>
		
            
			<li>
                <a href="{{route('schoolagentmember.members')}}">
			 ...
			 <li>
                <a href="{{route('schoolagentmember.deletedmembers')}}">
             ...
             <li>
                <a href="{{route('schoolagentmember.import')}}">
                    <span class="sidebar-mini"> IM </span>
                    <span class="sidebar-normal"> Import  Users</span>
                </a>
            </li>
 ...
 <nav class="navbar navbar-transparent navbar-absolute">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"> Department Admin Dashboard - {{$sname}} - {{$divname}} @if (session('status'))
