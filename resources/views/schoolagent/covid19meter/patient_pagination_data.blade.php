   ...
   @foreach( $covid_assessd_patients as $patient)
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-left">
                                                ...
                                                <a href="{{route('depadminpatientinfo',$patient->id)}}" type="button"><i class="material-icons btn-success">person</i></a>
	<a href="{{URL::to('/')}}/covid19assesdpatients/reports/{{$patient->patientreport}}" type="button" traget="_blank"><i class="material-icons btn-success">description</i></a>											
												
                                                 <a href="{{action('Schoolagent\CovidMeterController@editpatientinfo',$patient->id)}}" type="button"><i class="material-icons btn-primary">create</i></a>
