...
@section('title')
  Profile - Manage District  Agents Medix
@endsection
@section('content')
...
<div class="col-md-12">
	@foreach($agents as $member)
			<div class="card">
				<h4 align="center">Division Agent Details - {{$member->name}} {{$member->lname}} , {{$member->ps_number}}</h4>
...
<a href="/admin/divisionalagents" class="btn btn-info pull-right">Back</a>
