...
@section('title')
  Home-Manage Hospital Admins  - Medix
@endsection
@section('content')
                       ...
                       @if($message = Session::get('success'))
                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Hospital Admins</h4>
                              <form action="/recycleAllhospitaladmins"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/recycleAllhospitaladmins" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('dashboard.pages.divisionadmin.divisional_agent_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,province,district,zone,division,query)
            {
                $.ajax({
                    ...
                    url:"divisionalagents/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&province="+province+"&district="+district+"&zone="+zone+"&division="+division+"&query="+query,
