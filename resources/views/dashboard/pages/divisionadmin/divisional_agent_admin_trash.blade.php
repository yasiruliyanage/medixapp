...
@section('title')
  Home-Manage District Agents Medix
@endsection
@section('content')
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Divisional Agents</h4>
                              <form action="/deletealldivisionalagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/deletealldivisionalagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Delete?')" >Delete All Selected </button>
                                <button formaction="/restorealldivisionalagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
                                    <div class="col-md-2">
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,province,district,zone,division,query)
            {
                $.ajax({
                    ...
                    url:"divisionalagents/fetch_trash_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&province="+province+"&district="+district+"&zone="+zone+"&division="+division+"&query="+query,
