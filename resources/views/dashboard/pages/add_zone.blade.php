...
<div class="col-md-12">
  <div class="col-md-12">
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Hospital Type Manage</h4>
            <form method="post" action="{{route('zone.add')}}" class="form-horizontal">
        ...
        <div class="card-content">
            ...
            <div class="row">
                <label style="color: black;" class="col-sm-2 label-on-left">Hospital Type Name</label>

                <div class="col-sm-10">
                    <div class="form-group label-floating is-empty">
                        <label class="control-label"></label>
                        <input type="text" class="form-control" name="place_name" >
                        <span class="help-block">Please enter Hospital Type name.</span>
                    </div>
                </div>
