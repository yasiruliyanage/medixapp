...
<div class="col-md-12">
			<div class="card">
				<h4 align="center" style="font-weight:500;font-size:20px;">Application of Add New District Agent </h4>
				...
				@endif
				<form id="myfrm" method="post" action="{{ route('districtagent.add') }}" class="form-horizontal" enctype="multipart/form-data">
					{{csrf_field()}}
						...
						<div class="row">
                        	...
                        	<div class="col-sm-10">
								<div class="form-group label-floating is-empty">
									...
									<input type="text"   value="{{ old('reg_id') }}"class="form-control" >
									<input type="hidden" name="reg_id"  value="{{ old('reg_id') }}"class="form-control" >
