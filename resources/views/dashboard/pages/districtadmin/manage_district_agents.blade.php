...
@section('content')
                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">District Agents</h4>
                              <form action="/recycleAlldistrictagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/recycleAlldistrictagents" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('dashboard.pages.districtadmin.district_agent_pagination_data')
    ...
    <script>
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,province,district,query)
            {
                $.ajax({

                    url:"districtagents/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&province="+province+"&district="+district+"&query="+query,
          ...
          $('.filtercheck').change(function(){
              ...
              console.log(province_id);
                ...
                fetch_data(page,sort_type,column_name,province_id,district_id,query);
          ...
          $(document).on('keyup','#search',function(){
           ...
           //sorting function
            $(document).on('click','.sorting',function(){
                ...
                fetch_data(page,reverse_order,column_name,province_id,district_id,query);
