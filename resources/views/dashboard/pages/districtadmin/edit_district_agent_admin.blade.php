...
<div class="col-md-12">
			<div class="card">
				<h4 align="center" style="font-weight:500;font-size:20px;">District Agent  Details</h4>
				...
				<form method="POST" action="{{ route('districtagent.edit',$member->id)}}" class="form-horizontal" enctype="multipart/form-data">
				{{csrf_field()}}
					...
					<div class="card-content">
                       ...
                       <div class="row">
                        ...
                        <a href="/admin/districtagents" class="btn btn-danger pull-right" >Cancel</a>
