...
@section('title')
  Home-Export Users Reports to  PDF
@endsection
@section('content')
  ...
  <div class="col-md-12">
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Export Members By Groups </h4>
            <form method="get" action="{{route('pdfreports.exportgrouppdf')}}" class="form-horizontal">
 ...
 <div class="col-md-12">
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Export Members By Workplace </h4>
            <form method="get" action="{{route('pdfreports.exportworkplacepdf')}}" class="form-horizontal">
          <!--div class="card-header card-header-text" data-background-color="rose">
            <h4 class="card-title"></h4>
        </div-->
        <div class="card-content">
     ...
     <div class="col-md-12">
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Export Members By Designation </h4>
            <form method="get" action="{{route('pdfreports.exportdesignationpdf')}}" class="form-horizontal">
          <!--div class="card-header card-header-text" data-background-color="rose">
            <h4 class="card-title"></h4>
        </div-->
        <div class="card-content">
     ...
     <div class="col-md-12">  
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Export Single Member Report </h4>
            <form method="get" action="{{route('pdfreports.exportuserpdf')}}" class="form-horizontal">
          <!--div class="card-header card-header-text" data-background-color="rose">
            <h4 class="card-title"></h4>
        </div-->
        <div class="card-content">
