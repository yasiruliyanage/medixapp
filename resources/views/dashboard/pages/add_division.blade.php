...
<div class="col-md-12">
  <div class="col-md-12">
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Hospital Manage</h4>
            <form method="post" action="{{route('division.add')}}" class="form-horizontal">
        ...
        <div class="card-content">
            ...
            <div class="row">
                <label style="color: black;" class="col-sm-2 label-on-left">Hospital Name</label>
