...
@section('title')
  Home-Edit  Hospital Type Admin - Medix
@endsection
@section('content')
...
<div class="col-md-12">
			<div class="card">
				<h4 align="center" style="font-weight:500;font-size:20px;"> Hospital Type Admin  Details</h4>
				...
				<form method="POST" action="{{ route('hospitaltypegent.edit',$member->id)}}" class="form-horizontal" enctype="multipart/form-data">
				{{csrf_field()}}
					...
					<div class="card-content">
						...
						<div class="row">
                        	...
                        	<div class="col-sm-10">
								<div class="form-group label-floating is-empty">
                                    ...
                                    <input type="hidden" name="ps_number">
                       ...
                       <div class="row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <div class="row">
                            <label class="col-sm-2 label-on-left"> Hospital Type</label>
                        <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                        ...
                        <a href="/admin/hospitaltypeadmins" class="btn btn-danger pull-right" >Cancel</a>
