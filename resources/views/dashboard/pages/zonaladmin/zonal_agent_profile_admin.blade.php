...
@section('title')
  Profile - Manage Zonal  Agents Medix
@endsection
@section('content')
...
<div class="col-md-12">
	@foreach($agents as $member)
			<div class="card">
				<h4 align="center">Hospital Type Admin Details - {{$member->name}} {{$member->lname}} , {{$member->ps_number}}</h4>
...
<a href="/admin/hospitaltypeadmins" class="btn btn-info pull-right">Back</a>
