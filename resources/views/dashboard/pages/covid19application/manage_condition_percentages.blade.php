...
@section('title')
  Home-Manage Condition Percentages - Medix
@endsection
@section('content')
                       ...
                       @if($message = Session::get('success'))
                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Covid Decission Conditions </h4>
                                    ...
                                    <thead>
                                        ...
                                        <tr >
                                            ...
                                            <th scope="col">No</th>
                                                ...
                                                >percentage<span id="reg_id_icon"></span></th>
                                                <th scope="col">Actions</th>
                                        </tr>

                                    </thead>
                                    <tbody>
                                     @include('dashboard.pages.covid19application.decessions_pagination_data')
