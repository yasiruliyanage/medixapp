...
@section('title')
  Home-Manage Questions  Trash- Medix
@endsection
@section('content')
                        ...
                        @endif
                         ...
                         <div class="card-content">.
                            <h4 class="card-title">Covid Questions </h4>
                              <form action="deleteallquestions"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="deleteallquestions" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('dashboard.pages.covid19application.questions_pagination_trash_data')
