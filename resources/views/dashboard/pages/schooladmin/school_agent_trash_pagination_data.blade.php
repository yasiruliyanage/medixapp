   ...
   @foreach($agents as $member)
                                ...
                                @if(($member->role_id==7)&&($member->inRecycle==1))       
                                 <tr>
                                            ...
                                            <td class="td-actions text-left">
                                                  ...
                                                  <a href="{{route('departmentagent.restore',$member->id)}}" onclick="return confirm('Are you sure you want to restore?')" type="button"><i class="material-icons btn-primary">restore_page</i></a>
