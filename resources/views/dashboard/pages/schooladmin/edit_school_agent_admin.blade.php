...
@section('title')
  Home-Edit  District Agents  Medix
@endsection
@section('content')
...
<div class="col-md-12">
			<div class="card">
				<h4 align="center" style="font-weight:500;font-size:20px;">School Agent  Details</h4>
				...
				<form method="POST" action="{{ route('departmentagent.edit',$member->id)}}" class="form-horizontal" enctype="multipart/form-data">
				{{csrf_field()}}
					...
					<div class="card-content">
						...
						<div class="row">
                        	...
                        	<div class="col-sm-10">
								<div class="form-group label-floating is-empty">
                                    ...
                                    <input type="hidden" name="emp_id" class="" placeholder="noempid" value="noempid"  >
                                 
                       
                                    <input type="hidden" name="ps_number" value="nopsnumber" class="" >
                       ...
                       <div class="row">
                        ...
                        <a href="/admin/departmentadmins" class="btn btn-danger pull-right" >Cancel</a>
