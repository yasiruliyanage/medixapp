...
@section('title')
  Home-Add Department Admin -Medix
@endsection
@section('content')
...
<div class="col-md-12">
			<div class="card">
				<h4 align="center" style="font-weight:500;font-size:20px;">Application of Add New Department Admin </h4>
				...
				@endif
				<form id="myfrm" method="post" action="{{ route('departmentagent.add') }}" class="form-horizontal" enctype="multipart/form-data">
					{{csrf_field()}}
						...
						<div class="row">
                        	...
                        	<div class="col-sm-10">
								<div class="form-group label-floating is-empty">
									...
									<input type="text"   value="MEDIX/DA/{{ $newregid }}"class="form-control" disabled>
                                    <input type="hidden" name="reg_id"  value="MEDIX/DA/{{ $newregid }}"class="form-control" >
						...
						<div class="row">
                        	...
                        	<div class="col-sm-10">
								<div class="form-group label-floating is-empty">
                                    ...
                                    <input type="hidden" name="emp_id" class="" value="noempid" >
                                  
							
                                    <input type="hidden" name="ps_number" value="" class="" >
