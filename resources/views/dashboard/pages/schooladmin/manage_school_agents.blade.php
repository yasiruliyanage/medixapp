...
@section('title')
  Home-Manage School Agents Medix
@endsection
@section('content')
                       ...
                       @if($message = Session::get('success'))
                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Department Admins</h4>
                              <form action="/recycleAlldepartmentadmins"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/recycleAlldepartmentadmins" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('dashboard.pages.schooladmin.school_agent_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,province,district,zone,division,school,query)
            {
                $.ajax({
                    ...
                    url:"departmentadmins/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&province="+province+"&district="+district+"&zone="+zone+"&division="+division+"&school="+school+"&query="+query,
