        ...
        <div class="card">
            ...
            <div class="card-content">
                <h4 class="card-title">News Details</h4>
                     ...
                     <form action="/recycleAllnews"  method="post">
                                @csrf
                                @method('DELETE')
                             ...
                             @foreach($news as $new)
                                <tr>
                                        ...
                                        <td class="td-actions text-left">
                                                <a type="button" class="btn btn-info" href="{{route('news.show',$new->id)}}" ><i class="material-icons">person</i></a>
                                               <a href="{{action('NewsController@edit',$new->id)}}" type="button"><i class="material-icons btn-primary">create</i></a>
                                              
                                                 <a type="button" href="{{route('news.recycle',$new->id)}}" onclick="return confirm('Are you sure you want to Delete?')" ><i class="material-icons  btn btn-danger ">delete</i> </a>
                                         </td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                      <button formaction="/recycleAllnews" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Delete?')" >Delete All Selected </button>
                </form>
