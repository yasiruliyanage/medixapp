@extends('staff.province_agents.layouts.main')
 ...
 <div class="container-fluid" style="padding-bottom:0px;">
     <div class="row">
         <div class="col-md-12">
             <div class="card">
                 <h4 align="center" style="font-weight:500;font-size:20px;">Division Agent Registration </h4>
                 ...
                 <form id="myfrm" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                     <div class="card-content">
                         ...
                         <a href="province_dash" class="btn btn-danger pull-right">Cancel</a>
