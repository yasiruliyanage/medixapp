        ...
        <div class="sidebar" data-active-color="rose" data-background-color="black" data-image="{{URL::asset('assets/assets/img/sidebar-t.jpg')}}">
            ...
            <div class="sidebar-wrapper">
                <div class="user">
                    ...
                    <div class="info">
                        ...
                        <div class="collapse" id="collapseExample">
                            <ul class="nav">
                                <li>
                                    <a href="view_div_a_pro">
                                        <span class="sidebar-mini"> MP </span>
                                        <span class="sidebar-normal"> My Profile </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="edit_div_a_pro">
                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="division_dash">
                            <i class="material-icons">dashboard</i>
                            <p>Division Agent Dashboard </p>
                        </a>
                    </li>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Division Agent Dashboard
