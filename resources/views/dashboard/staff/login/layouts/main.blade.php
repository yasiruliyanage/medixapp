...
<body class="off-canvas-sidebar">
    <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
           <div class="">
                    <a class="navbar-brand btn btn-info " href="/ ">  <i class="material-icons">home</i></a>
            </div>
    ...
    <div id="loginimg" class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="{{URL::asset('assets/assets/img/register.jpeg')}}">
                ...
                <footer id="loginftr" class="footer">
                    <div id="ftext" class="container">
                        ...
                        <p class="copyright text-center" style="padding-top: 30px;">
                            Copyright © 2019.Ceylon Teachers Service Union Developed By<a target="_blank" href="https://www.cisworld.lk/"> CIS WORLD</a>
                        </p>
                    </div>
                </footer>
            </div>
