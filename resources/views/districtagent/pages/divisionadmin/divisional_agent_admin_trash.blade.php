...
@section('title')
  Home-Manage Divisional Agents CTSU
@endsection
@section('content')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-left">
                                                 ...
                                                 <a href="{{route('divisionalagent.restore',$member->id)}}" onclick="return confirm('Are you sure you want to restore?')" type="button"><i class="material-icons btn-primary">restore_page</i></a>
