   ...
   <div class="sidebar-wrapper">
    <div class="user">
		 <div class="photo" style="width:60px;height:60px">
            ...
            <img src="{{URL::to('/')}}/members/profileimg/male-avatar.png" />
			<?php }else {?>
			<img src="{{URL::to('/')}}/members/profileimg/female-avatar.png" />
			<?php }?>
 ...
 <div class="collapse" id="componentsExamples2">
    <ul class="nav">
        <li>
		  ...
		  <li>
            <a href="{{route('usercovid19patients')}}">
...
<script type="text/javascript">
   ...
   // $("#myValues2").myfunc({divFact:30});
    ...
    $('#pid').on('change',function(e){
        ...
        $.get('/json-districts-user?p_id='+p_id,function(data){
            console.log(data);
     ...
     $('#did').on('change',function(e){
        ...
        $.get('/json-zones-user?d_id='+d_id,function(data){
            console.log(data);
       ...
       $('#zid').on('change',function(e){
        ...
        $.get('/json-divisions-user?z_id='+z_id,function(data){
            console.log(data);
    ...
    $('#divid').on('change',function(e){
        ...
        $.get('/json-schools-user?div_id='+div_id,function(data){
            console.log(data);
