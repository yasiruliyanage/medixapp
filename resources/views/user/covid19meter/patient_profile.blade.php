...
<div class="col-md-12">
  <div class="col-md-12">
   <div class="card">
    <h4 align="center">Patient Profile</h4>
                   ...
                   <div class="col-sm-10">
                    <div class="form-group label-floating is-empty">
                     ...
                     <input type="text" class="form-control"  value="{{$patient->patient_no}}" disabled >
                      <input type="hidden" class="form-control" name="patient_no"  value="{{$patient->patient_no}}">
                 </div>
             </div>
         </div>
          <div class="row">
...
<div class="row">
        <label class="col-sm-2 label-on-left">Patient Results</label>
     
        <div class="col-sm-10">
         <div class="form-group label-floating is-empty">
          <label class="control-label"></label>
          <input type="text" class="form-control"  name="phone" value="{{ $patient->patient_results }}"  >
          
      </div>
     </div>
 </div>
 <div class="row">
        <label class="col-sm-2 label-on-left">Patient Result Decession</label>
     
        <div class="col-sm-10">
         <div class="form-group label-floating is-empty">
          <label class="control-label"></label>
          <input type="text" class="form-control"  name="phone" value="{{ $patient->patient_result_decission }}"  >
...
<div class="row">
              <label style="color: black;" class="col-sm-2 label-on-left">Interviewed At</label>

                          <div class="col-sm-10">
                <div class="form-group label-floating is-empty">
                  <label class="control-label"></label>
                  <input type="date" name="dob" value="{{ $patient->interviewed_at }}" class="form-control" >
...
<div class="row">
    ...
    <picture>
        <img src="{{URL::to('/')}}/covid19assesdpatients/profileimg/{{$patient->profile_img}}" alt="" style="width:200px;height: 200px;" disabled>
      </picture>
</div>
