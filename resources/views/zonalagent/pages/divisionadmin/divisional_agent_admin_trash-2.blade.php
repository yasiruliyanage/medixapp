...
@section('title')
  Home-Manage Division Agents CTSU
@endsection
@section('content')
<?php $nav = 'divisional_admin'; ?>
          ...
          @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">Divisional Agents</h4>
                              <form action="/zonalagent/divisionagents/deleteallzonalagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="/zonalagent/divisionagents/deleteallzonalagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Delete?')" >Delete All Selected </button>
                                <button formaction="/zonalagent/divisionagents/restoreallzonalagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('zonalagent.pages.divisionadmin.divisional_agent_trash_pagination_data')
  ...
  <script>
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,division,query)
            {
                $.ajax({

                    url:"divisionagents/fetch_trash_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&division="+division+"&query="+query,
          ...
          $('.filtercheck').change(function(){
               ...
               var page = $('#hidden_page').val();
                ...
                fetch_data(page,sort_type,column_name,division_id,query);
           ...
           //sorting function
            $(document).on('click','.sorting',function(){
               ...
               var division_id= $('#divid').val();
                ...
                fetch_data(page,reverse_order,column_name,division_id,query);
