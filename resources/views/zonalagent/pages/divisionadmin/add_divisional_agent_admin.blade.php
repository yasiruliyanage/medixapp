...
<div class="col-md-12">
			<div class="card">
				<h4 align="center" style="font-weight:500;font-size:20px;">Application of Add New Divisional Agent </h4>
				...
				@endif
				<form id="myfrm" method="post" action="{{ route('zonaldivisionagent.add') }}" class="form-horizontal" enctype="multipart/form-data">
					{{csrf_field()}}
