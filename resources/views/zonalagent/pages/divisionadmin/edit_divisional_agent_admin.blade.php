...
<div class="col-md-12">
			<div class="card">
				<h4 align="center" style="font-weight:500;font-size:20px;">Divisional Agent  Details</h4>
				...
				<form method="POST" action="{{ route('zonaldivisionagent.edit',$member->id)}}" class="form-horizontal" enctype="multipart/form-data">
				{{csrf_field()}}
