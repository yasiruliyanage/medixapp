...
<body >
   ...
   <div class="sidebar-wrapper">
    <div class="user">
        <div class="photo">
            <img src="{{URL::to('/')}}/provinceagents/profileimg/{{Auth::user()->profile_img}}" />
        </div>
        <div class="info">
           ...
           <div class="collapse" id="collapseExample">
            <ul class="nav">
                 <li class="@if ($nav == 'my_profile') active @endif">
                    <a href="{{route('provinceagentuser.profile')}}">
                        <span class="sidebar-mini"> MP </span>
                        <span class="sidebar-normal"> My Profile </span>
                    </a>
                </li>
                <li class="@if ($nav == 'edit_profile') active @endif">
                    <a href="{{route('provinceagentuser.editprofile')}}">
                        <span class="sidebar-mini"> EP </span>
                        <span class="sidebar-normal"> Edit Profile </span>
                    </a>
                </li>
                 <li class="@if ($nav == 'change_pass') active @endif">
                    <a href="{{route('provinceagentuser.changepassword')}}">
...
<ul class="nav">
    ...
    <li >
        <a href="{{route('provinceagentuser.home')}}">
    ...
    <li class="@if ($nav == 'member_admin') active @endif">
     ...
     <div class="collapse" id="pagesExamples">
        <ul class="nav">
            <li>
                <a href="{{route('provinceagentuser.members')}}">
                    <span class="sidebar-mini"> TIP </span>
                    <span class="sidebar-normal">Teachers in Province</span>
                </a>
            </li>
        </ul>
    </div>
...
<!--############################  Staff Members   #####################################-->
     ...
     <div class="collapse" id="pagesExamplesS">
        <ul class="nav">
			  ...
			  <li>
                <a href="{{route('provincedistrictagent.add')}}">
			...
			<li>
                <a href="{{route('provincedistrictagent.agents')}}">
			 ...
			 <li>
                <a href="{{route('provincedistrictagent.deletedagents')}}">
...
<!--############################  Staff Members   #####################################-->
     ...
     <li class="@if ($nav == 'zonal_admin') active @endif" >
        <a data-toggle="collapse" href="#pagesExamplesZA">
            <i class="material-icons">assignment_ind</i>
            <p>Zonal Agents
             <b class="caret"></b>
         </p>
     ...
     <div class="collapse" id="pagesExamplesZA">
        <ul class="nav">
            
              <li>
                <a href="{{route('provinceagentuser.zones')}}">
                    <span class="sidebar-mini"> ZA </span>
                    <span class="sidebar-normal"> Zonal Agents </span>
                </a>
            </li>
...
<!--############################  Staff Members   #####################################-->
     ...
     <div class="collapse" id="pagesExamplesDIVA">
        <ul class="nav">
              ...
              <li>
                <a href="{{route('provinceagentuser.divisions')}}">
                    <span class="sidebar-mini"> DIVA </span>
                    <span class="sidebar-normal"> Divisional Agents </span>
                </a>
            </li>
...
<!--############################  Staff Members   #####################################-->
     ...
     <div class="collapse" id="pagesExamplesSCA">
        <ul class="nav">
              ...
              <li>
                <a href="{{route('provinceagentuser.schools')}}">
                    <span class="sidebar-mini"> SCA </span>
                    <span class="sidebar-normal"> School Agents </span>
                </a>
            </li>
 ...
 <nav class="navbar navbar-transparent navbar-absolute">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"> Province Agent Dashboard  @if (session('status'))
