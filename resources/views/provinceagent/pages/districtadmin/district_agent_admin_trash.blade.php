                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">District Agents</h4>
                              <form action="deletealldistrictagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="deletealldistrictagents" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                 <button formaction="restorealldistrictagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
