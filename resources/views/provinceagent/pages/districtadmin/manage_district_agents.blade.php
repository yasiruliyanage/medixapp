                        ...
                        @endif
                         ...
                         <div class="card-content">
                            <h4 class="card-title">District Agents</h4>
                              <form action="districagents/recyclealldistrictagents"  method="post">
                                @csrf
                                @method('DELETE')
                                <button formaction="districagents/recyclealldistrictagents" class="btn btn-danger" type="submit" >Delete All Selected </button>
                                <div class="row">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('provinceagent.pages.districtadmin.district_agent_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,district,query)
            {
                $.ajax({
                    ...
                    url:"districagents/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&district="+district+"&query="+query,
