                         ...
                         <div class="card-content">
                            <h4 class="card-title">School Agents</h4>
                              <form action="/deletealldepartmentadmins"  method="post">
                                ...
                                <button formaction="/restorealldepartmentadmins" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,school,query)
            {
                $.ajax({
                    ...
                    url:"departmentadmins/fetch_data_trash?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&school="+school+"&query="+query,
