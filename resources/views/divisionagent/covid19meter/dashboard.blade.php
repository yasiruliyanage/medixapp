                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">
								 <?php 
                                          $members= DB::select('select * from covid_assessd_patients where  patient_department=?',[Auth::user()->division]  );
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">
								<?php 
                                          $events=DB::select('select * from covid_assessd_patients where patient_result_decission="normal" and patient_hospital=?',[Auth::user()->division] );
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">
								<?php 
                                          $events=DB::select('select * from covid_assessd_patients where patient_result_decission="selfquarantine" and patient_hospital=?',[Auth::user()->division] );
                                          $event_count=count($events);
                                          echo $event_count;
                                       ?>
							</h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">
								 <?php 
                                          $groups=DB::select('select * from covid_assessd_patients where patient_result_decission="OPD" and patient_hospital=?',[Auth::user()->division] );
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-content">
                            ...
                            <h3 class="card-title">
                 <?php 
                                          $groups=DB::select('select * from covid_assessd_patients where patient_result_decission="covid19positive" and patient_hospital=?',[Auth::user()->division] );
                                          $group_count=count($groups);
                                          echo $group_count;
                                       ?>
