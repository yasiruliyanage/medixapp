...
<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.7/css/select2.min.css" rel="stylesheet" />
  ...
  rel="stylesheet">
    ...
    <link href="{{URL::asset('covidmeter/css/speedometer.css')}}" rel="stylesheet" type="text/css" />
...
<script src="{{URL::asset('assets/assets/js/jquery.datatables.js')}}"></script>
 <script src="{{URL::asset('covidmeter/js/speedometer.js')}}"></script>
   ...
   <div class="sidebar-wrapper">
    <div class="user">
		 ...
		 <div class="photo" style="width:60px;height:60px">
            ...
            <img src="{{URL::to('/')}}/divisionalagents/profileimg/male-avatar.png" />
			<?php }else {?>
			<img src="{{URL::to('/')}}/divisionalagents/profileimg/female-avatar.png" />
			<?php }?>
           ...
           <div class="collapse" id="collapseExample">
            <ul class="nav">
                 <li class="@if ($nav == 'my_profile') active @endif">
                    <a href="{{route('divisionagentuser.profile')}}">
                        <span class="sidebar-mini"> MP </span>
                        <span class="sidebar-normal"> My Profile </span>
                    </a>
                </li>
                <li class="@if ($nav == 'edit_profile') active @endif">
                    <a href="{{route('divisionagentuser.editprofile')}}">
                        <span class="sidebar-mini"> EP </span>
                        <span class="sidebar-normal"> Edit Profile </span>
                    </a>
                </li>
                 <li class="@if ($nav == 'change_pass') active @endif">
                    <a href="{{route('divisionagentuser.changepassword')}}">
...
<ul class="nav">
    ...
    <li >
        <a href="{{route('divisionagentuser.home')}}">
    ...
    <li class="@if ($nav == 'member_admin') active @endif">
     ...
     <div class="collapse" id="pagesExamples">
        <ul class="nav">
            <li>
                <a href="{{route('divisionagentuser.members')}}">
                    <span class="sidebar-mini"> UIH </span>
                    <span class="sidebar-normal">Users in Hospital</span>
                </a>
            </li>
        </ul>
    </div>
...
<!--############################  Staff Members   #####################################-->
	 ...
	 <li class="@if ($nav == 'distict_admin') active @endif">
        <a data-toggle="collapse" href="#pagesExamples6">
     ...
     <div class="collapse" id="pagesExamples6">
        <ul class="nav">
			  ...
			  <li>
                <a href="{{route('divisionschoolagent.add')}}">
                    <span class="sidebar-mini"> RDA </span>
			...
			<li>
                <a href="{{route('divisionschoolagent.agents')}}">
                    <span class="sidebar-mini"> MSA </span>
                    <span class="sidebar-normal"> Manage Department Admins </span>
                </a>
            </li>
			 
			 <li>
                <a href="{{route('divisionschoolagent.deletedagents')}}">
                    <span class="sidebar-mini"> DSA </span>
...
<li>
 ...
 <div class="collapse" id="componentsExamples2">
    <ul class="nav">
        <li>
            <a href="{{route('hospitaladmincovid19meterdashboard')}}">
                <span class="sidebar-mini"> MD </span>
                <span class="sidebar-normal"> Covid 19 meter Dashboard</span>
            </a>
        </li>
         <li>
            <a href="{{route('hospitaladmincovid19patients')}}">
                <span class="sidebar-mini">  </span>
                <span class="sidebar-normal"> Manage Patients</span>
            </a>
        </li>
...
<li>
    ...
    <a data-toggle="collapse" href="#componentsExamplesdep">
        <i class="material-icons">assignment</i>
        <p> Departments
         <b class="caret"></b>
     </p>
 ...
 <div class="collapse" id="componentsExamplesdep">
    <ul class="nav">
        <li>
            <a href="{{route('divdepartments')}}">
                <span class="sidebar-mini"> DM </span>
                <span class="sidebar-normal"> Manage Departments</span>
            </a>
        </li>
         <li>
            <a href="{{route('divschools.add')}}">
                <span class="sidebar-mini">  </span>
                <span class="sidebar-normal"> Add Departments</span>
            </a>
        </li>
 ...
 <nav class="navbar navbar-transparent navbar-absolute">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"> Hospital Admin Dashboard {{$divname}}  Hospital  @if (session('status'))
