...
<div class="col-md-12">
  <div class="col-md-12">
      <div class="card">
        <h4 align="center" style="font-weight:500;font-size:20px;">Add Department</h4>
            <form method="post" action="{{route('divschools.add')}}" class="form-horizontal">
