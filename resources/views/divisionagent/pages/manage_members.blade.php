                            ...
                            <h4 class="card-title">Users</h4>
                              ...
                              <form action="/recycleAll"  method="post">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('dashboard.pages.member_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,province,district,zone,division,school,query)
            {
                $.ajax({
                    ...
                    url:"members/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&province="+province+"&district="+district+"&zone="+zone+"&division="+division+"&school="+school+"&query="+query,
