                         ...
                         <div class="card-content">
                            <h4 class="card-title">Department Admins</h4>
                              <form action="deleteallschoolagents"  method="post">
                                ...
                                <button formaction="recycleallschoolagents" class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to Restore?')">Restore All Selected </button>
                                <div class="row">
