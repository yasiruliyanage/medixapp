...
@section('title')
  Home-Manage Department Admins - Medix.lk
@endsection
@section('content')
                            ...
                            <h4 class="card-title">Department Admins</h4>
                              <form action="/recycleAlldepartmentadmins"  method="post">
                                ...
                                <table id="member_table" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%" style="border: 1px solid black; ">
                                    ...
                                    <tbody>
                                     @include('divisionagent.pages.schooladmin.school_agent_pagination_data')
        ...
        $(document).ready(function(){
            function  fetch_data(page,sort_type,sort_by,school,query)
            {
                $.ajax({
                    ...
                    url:"departmentadmins/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&school="+school+"&query="+query,
